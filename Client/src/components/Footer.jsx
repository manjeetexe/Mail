    ...
    <div className="relative text-black py-5">
      ...
      <div className="px-10 mx-auto">
        <div className='flex gap-3'>
          ...
          <h1 className='text-3xl px-7 font-semibold'>Quantum Musing</h1>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 px-10 gap-8">
          ...
          <div className=''>
            <h4 className="text-xl text-black font-bold mb-4">Help</h4>
          ...
          <div>
            <h4 className="text-xl font-bold text-black mb-4">Social Media</h4>
            <ul className="space-y-2">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <form className='flex gap-3' action="">
                <input type="text" placeholder='Enter your Email' className='rounded-lg bg-gray-300 py-2 px-3 w-40' />
        ...
        <div className="flex flex-col md:flex-row items-center px-10 justify-between mt-6">
          ...
          <div className="flex space-x-4">
            <a href="https://www.instagram.com/makeupartist_vaishnavi.k?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" className="text-black text-xl hover:opacity-80"><RiInstagramFill /></a>
            <a href="mailto:manjeetsharma9257@gmail.com" className="text-black text-xl hover:opacity-80"><MdEmail /></a>
            <a href="tel:9370612327" className="text-black rotate-90 hover:opacity-80"><FaPhone /></a>
          </div>
