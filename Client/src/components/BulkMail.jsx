      ...
      <div className="bg-white shadow-lg rounded-lg p-6 w-full max-w-3xl">
        ...
        <form className="space-y-4">
          {selectedOption !== 'ultimate' && (
            <>
              <input className="w-full p-2 border rounded" type="email" placeholder="CC" />
              <input className="w-full p-2 border rounded" type="email" placeholder="BCC" />
            </>
          )}
          <input 
          ...
          <textarea 
            ...
            required
          ></textarea>
          {selectedOption !== 'few' && <input className="w-full p-2 border rounded" type="file" accept="application/pdf" required />}
          <button className="w-full bg-blue-600 text-white p-2 rounded">Send Email</button>
